package pe.esgtrazabilidad.reporting.it.support;
 ...
 * shape as recycler-service's and collection-service's own copies) --
...
public final class TestJwtTokens {
    ...
    public static final String TEST_SECRET = "reporting-service-it-test-secret-at-least-32-bytes!!";
